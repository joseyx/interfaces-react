...
// Users
const UsersTable = React.lazy(() => import('./views/users/usersTable/usersTable'))
...
const routes = [
  ...
  { path: '/dashboard/base/tabs', name: 'Tabs', element: Tabs },
  ...
  { path: '/dashboard/buttons/button-groups', name: 'Button Groups', element: ButtonGroups },
  ...
  { path: '/dashboard/forms/checks-radios', name: 'Checks & Radios', element: ChecksRadios },
  { path: '/dashboard/forms/range', name: 'Range', element: Range },
  { path: '/dashboard/forms/input-group', name: 'Input Group', element: InputGroup },
  { path: '/dashboard/forms/floating-labels', name: 'Floating Labels', element: FloatingLabels },
  ...
  { path: '/dashboard/notifications', name: 'Notifications', element: Alerts, exact: true },
